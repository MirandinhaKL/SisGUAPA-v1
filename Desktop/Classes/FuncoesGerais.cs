...
namespace Desktop.Classes
{
    static class FuncoesGerais
    {
        ...
        public static string GetDescricaoFrequenciaIngestao(int enumFrequenciaIngestao, int auxiliarX, int auxiliarY, string diasDaSemana)
        {
            ...
            if (enumFrequenciaIngestao == (int)Enumeracoes.EnumFrequenciaIngestao.diariamenteXvezesDia)
                return $"{auxiliarX} vez ao dia";
            if (enumFrequenciaIngestao == (int)Enumeracoes.EnumFrequenciaIngestao.diariamenteCadaXhoras)
                return $"A cada {auxiliarX} hora(s)";
            if (enumFrequenciaIngestao == (int)Enumeracoes.EnumFrequenciaIngestao.cadaXdias)
                return $"A cada {auxiliarX} dia(s)";
            if (enumFrequenciaIngestao == (int)Enumeracoes.EnumFrequenciaIngestao.diasDaSemana)
            {
            ...
            if (enumFrequenciaIngestao == (int)Enumeracoes.EnumFrequenciaIngestao.ciclosXativosYinativos)
